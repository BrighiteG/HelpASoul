        ...
        if form.is_valid():
            ...
            for sub in subscribers:
                send_mail(
                    ...
                    html_message=loader.render_to_string('social_cases/socialcase_newsletter.html',
                                                         {'title': social_case.title,
                                                          'subject': social_case.description,
                                                          'goal': social_case.target_donation})
                                 + (
